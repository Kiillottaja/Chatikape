...
//        lista.add("DROP TABLE Alue;");
        ...
        lista.add("CREATE TABLE Viesti(id SERIAL PRIMARY KEY, nimimerkki VARCHAR(50), keskustelu_id integer, teksti VARCHAR(160) NOT NULL, pvm TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, FOREIGN KEY (nimimerkki) REFERENCES Kayttaja (nimimerkki), FOREIGN KEY (keskustelu_id) REFERENCES Keskustelu (id));");
        ...
        lista.add("INSERT INTO Viesti(nimimerkki, keskustelu_id, teksti) VALUES('Teme', 1, 'Ei ole olemassa harmaata taloutta, kaikki on mustaa');");
        lista.add("INSERT INTO Viesti(nimimerkki, keskustelu_id, teksti) VALUES('Teme', 2, 'Hampaampaa on');");
        lista.add("INSERT INTO Viesti(nimimerkki, keskustelu_id, teksti) VALUES('Teme', 3, 'Kemistit on neroja!');");
        lista.add("INSERT INTO Viesti(nimimerkki, keskustelu_id, teksti) VALUES('Teme', 4, 'Mitenkäs tähän voisi liittyä?');");
        lista.add("INSERT INTO Viesti(nimimerkki, keskustelu_id, teksti) VALUES('Teme', 5, 'Tietokannat on kyl sekasin nyt');");
        lista.add("INSERT INTO Viesti(nimimerkki, keskustelu_id, teksti) VALUES('Teme', 6, 'Tuleekohan vaan valmiiksi....');");
        return lista;
    }
    ...
    private List<String> sqliteLauseet() {
        ...
        // tietokantataulujen luomiseen tarvittavat komennot suoritusjärjestyksessä
        lista.add("CREATE TABLE Kayttaja(nimimerkki VARCHAR(50) PRIMARY KEY, salasana VARCHAR(20) NOT NULL, CONSTRAINT Tarkastus CHECK (LENGTH(nimimerkki) > 2 AND LENGTH(salasana > 2)));");
        lista.add("CREATE TABLE Viesti(id integer PRIMARY KEY, nimimerkki VARCHAR(50), keskustelu_id integer, teksti VARCHAR(160) NOT NULL, pvm TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, FOREIGN KEY (nimimerkki) REFERENCES Kayttaja (nimimerkki), FOREIGN KEY (keskustelu_id) REFERENCES Keskustelu (id));");
