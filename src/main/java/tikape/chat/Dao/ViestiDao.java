...
public class ViestiDao implements Dao<Viesti, Integer> {
    ...
    public List<Alue> alueViestitYhteensaViimeisinViesti() throws SQLException {
        ...
        try (Connection conn = data.getConnection()) {
            PreparedStatement stmt = conn.prepareStatement("ELECT a.nimi nimi, COUNT(ke.id) maara, MAX(v.pvm) viimeisin FROM Alue a, Keskustelu ke, Viesti v WHERE v.keskustelu_id=ke.id AND v.alue_id=a.id Group BY a.nimi;");
